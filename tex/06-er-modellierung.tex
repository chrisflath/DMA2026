...
\begin{tikzpicture}[node distance=1.2cm, scale=0.85, transform shape]
    ...
    \node[roadmapbox, minimum width=2.8cm, right=of real] (er) {ER-Modell};
    \node[roadmapbox, minimum width=3.2cm, right=of er] (rel) {Rel. Schema};
    ...
    \draw[roadmaparrow] (er) -- (rel) node[midway, above, font=\footnotesize] {Transform.};
    \draw[roadmaparrow] (rel) -- (sql) node[midway, above, font=\footnotesize] {CREATE};
\end{tikzpicture}
\end{center}
