...
\begin{tikzpicture}[node distance=1.8cm]
    ...
    \node[roadmapbox, minimum width=3.5cm, right=of real, fill=green!10, draw=green!50!black] (er) {ER-Modell};
    \node[roadmapbox, minimum width=3.5cm, right=of er, fill=IMSOrange!20, draw=IMSOrange] (rel) {Relationales Schema};
