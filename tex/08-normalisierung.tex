...
\begin{tikzpicture}[node distance=0.8cm, scale=0.75, transform shape]
    \node[roadmapbox, minimum width=2.2cm] (real) {Reale Welt};
    \node[roadmapbox, minimum width=2.2cm, right=of real, fill=green!10, draw=green!50!black] (er) {ER-Modell};
    \node[roadmapbox, minimum width=2.2cm, right=of er, fill=green!10, draw=green!50!black] (rel) {Rel. Schema};
    \node[roadmapbox, minimum width=2.6cm, right=of rel, fill=IMSOrange!20, draw=IMSOrange] (norm) {Normalisierung};
    \node[roadmapbox, minimum width=2.2cm, right=of norm] (sql) {SQL-Tabellen};
