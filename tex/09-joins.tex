...
\begin{tikzpicture}[node distance=0.8cm, scale=0.75, transform shape]
    ...
    \node[roadmapbox, minimum width=2.6cm, right=of rel, fill=green!10, draw=green!50!black] (norm) {Normalisierung};
    \node[roadmapbox, minimum width=2.2cm, right=of norm, fill=IMSOrange!20, draw=IMSOrange] (join) {JOINs};
